...
<div class="max-w-4xl mx-auto px-4 py-16">
  <h1 class="text-3xl text-center font-heading mb-8">About This Wedding Website</h1>
  <div class="prose max-w-none">
    <p class="mb-4">Connor built this from scratch!</p>
    <p>
      You may not know this, but he is a programmer now. He wanted to put a personal touch on his to
      put a personal touch on his wedding website. He also wanted to learn how to build websites
